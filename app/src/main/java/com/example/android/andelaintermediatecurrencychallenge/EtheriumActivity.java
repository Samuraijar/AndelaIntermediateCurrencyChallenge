...
public class EtheriumActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ProgressDialog pDialog;
    private RecyclerView.Adapter recyclerAdapter;
    private String URL_DATA = "https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH&tsyms=USD,EUR,JPY,CHF,CAD,AUD,HKD,NGN,CNY,NZD,BRL,KRW,NOK,GBP,SEK,MXN,SGD,INR,ZAR,INS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eth_activity);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewAdapterClickListener(this, recyclerView, new RecyclerViewAdapterClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.setClass(EtheriumActivity.this, ConversionActivity.class);
                intent.putExtra("bit", bundle);
                intent.putExtra("bitcoins", "bitcoins");
                EtheriumActivity.this.startActivity(intent);
            }
    ...
    private class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            pDialog = new ProgressDialog(EtheriumActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            String json = sh.makeServiceCall(URL_DATA);
